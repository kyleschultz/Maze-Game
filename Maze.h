...
enum class SquareType { Wall, Exit, Empty, Human, Enemy, Treasure, Cherries, Pizza}; //Cherries = treasue, Pizza = treasure
...
//	// TODO: implement these functions
	...
	//destructor to free memory of dynamically created enemies
	~Maze();	
//
